class ComputerBuilder
  ...
  # builder.add_turbo_and_cd_dvd_and_harddisk. 
  # same trick as ActiveRecord's Employee.find_by_firstname_and_lastname('John', 'Smith')
  ...
  # builder can also have validation checks
  def computer
